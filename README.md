...
- [ ] **Sistem \
Escrow\ Vault:** Menahan token imbalan (XLM/USDC) secara otomatis di *Contract Balance* saat melapor, dan otomatis mentransfer token ke dompet sang penemu ketika barang disetujui.
